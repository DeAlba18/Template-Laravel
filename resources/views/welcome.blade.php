...
<head>
    <meta charset="utf-8">
    <title>Template Laravel - JUSTICIA</title>
                ...
                <div class="row bg-white border-bottom d-none d-lg-flex">
                    <div class="col-lg-7 text-left">
                        <div class="h-100 d-inline-flex align-items-center py-2 px-3">
                            ...
                            <small>diplomado@example.com</small>
                        </div>
                        <div class="h-100 d-inline-flex align-items-center py-2 px-2">
                            <i class="fa fa-phone-alt text-primary mr-2"></i>
                            <small>+57 3024099394</small>
                        </div>
                    </div>
                ...
                <nav class="navbar navbar-expand-lg bg-white navbar-light p-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="service.html" class="nav-item nav-link">Practicas</a>
                ...
                <div class="carousel-item position-relative" style="height: 100vh; min-height: 400px;">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            ...
                            <h3 class="display-2 text-capitalize text-white mb-4">Estamos preparados para oponernos por ti</h3>
        ...
        <div class="container py-5">
            <div class="row">
                <div class="col-lg-3">
                    ...
                    <h1 class="mb-4">Nuestras Áreas de Práctica</h1>
                ...
                <div class="col-lg-9 pt-5 pt-lg-0">
                    ...
                    <div class="owl-carousel service-carousel position-relative" style="margin-top: -100px; padding: 0 30px;">
                        ...
                        <div class="d-flex flex-column align-items-center text-center bg-white rounded pt-4">
                            ...
                            <h5 class="mb-4 px-4">Derecho penal</h5>
                            <p class="m-0">Takim stet justo elitr sea eirmod vero ipsum. Sed Stet clita sit duo dolor stet at at. Tempor dolor sit ipsum</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row h-100 align-items-center justify-content-center">
                    <div class="col-lg-6 py-5">
                        <div class="rounded p-5 my-5" style="background: rgba(55, 55, 63, .7);">
                            <h1 class="text-center text-white mb-4">Obtenga una cita</h1>
                            <form>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            <div class="date" id="date" data-target-input="nearest">
                                                <input type="text" class="form-control border-0 p-4 datetimepicker-input" placeholder="Seleccionar dato" data-target="#date" data-toggle="datetimepicker"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-group">
                                            <div class="time" id="time" data-target-input="nearest">
                                                <input type="text" class="form-control border-0 p-4 datetimepicker-input" placeholder="Seleccionar hora" data-target="#time" data-toggle="datetimepicker"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div>
                                    <button class="btn btn-primary btn-block border-0 py-3" type="submit">Obtenga una cita</button>
                                </div>
                            </form>
                        </div>
                    </div>
            ...
            <div class="bg-action rounded" style="height: 500px;">
                <div class="row h-100 align-items-center justify-content-center">
                    <div class="col-lg-7 text-center">
                        <h1 class="text-white mb-4">Comencemos. Llámenos ahora para una consulta gratuita</h1>
                        <a class="btn btn-primary py-3 px-5 mt-2" href="#">Llámenos ahora</a>
                    </div>
                </div>
            </div>
                ...
                <div class="col-12">
                    ...
                    <div class="owl-carousel team-carousel position-relative" style="margin-top: -97px; padding: 0 30px;">
                        <div class="team-item text-center bg-white rounded overflow-hidden pt-4">
                            ...
                            <p class="mb-3 px-4">Área de Práctica</p>
    ...
    <div class="container-fluid bg-secondary text-white pt-5 px-sm-3 px-md-5" style="margin-top: 90px;">
            ...
            <div class="col-lg-4">
                <div class="d-flex justify-content-lg-center p-4" style="background: rgba(256, 256, 256, .05);">
                    ...
                    <div class="ml-3">
                        ...
                        <p class="m-0">123 Cll, Lorica, Córdoba</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="d-flex justify-content-lg-center p-4" style="background: rgba(256, 256, 256, .05);">
                    ...
                    <div class="ml-3">
                        <h5 class="text-white">Envíenos un correo electrónico</h5>
        ...
        <div class="row pt-5">
            ...
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <div class="d-flex flex-column justify-content-start">
                    ...
                    <a class="text-white mb-2" href="#"><i class="fa fa-angle-right mr-2"></i>Acerda de</a>
                    <a class="text-white mb-2" href="#"><i class="fa fa-angle-right mr-2"></i>Servicios</a>
                    <a class="text-white mb-2" href="#"><i class="fa fa-angle-right mr-2"></i>Abogados</a>
            ...
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <div class="d-flex flex-column justify-content-start">
                    <a class="text-white mb-2" href="#"><i class="fa fa-angle-right mr-2"></i>Preguntas Frecuentes</a>
                    <a class="text-white mb-2" href="#"><i class="fa fa-angle-right mr-2"></i>Ayuda</a>
        ...
        <div class="row p-4 mt-5 mx-0" style="background: rgba(256, 256, 256, .05);">
            <div class="col-md-6 text-center text-md-left mb-3 mb-md-0">
                <p class="m-0 text-white">&copy; <a class="font-weight-bold" href="#">El nombre de su sitio</a>. Todos los derechos reservados.</p>
            </div>
            <div class="col-md-6 text-center text-md-right">
                <p class="m-0 text-white">Diseñado por <a class="font-weight-bold" href="https://htmlcodex.com">Ivan</a></p>
            </div>
        </div>
    </div>
    <!-- Footer End -->
